...
export default function AdminRegister() {
  ...
  const validate = () => {
    ...
    if (!form.accessCode.trim())
      e.accessCode = "Authorization code is required.";
    if (!form.password) e.password = "Password is required.";
    else if (form.password.length < 10)
      e.password = "Admin passwords require at least 10 characters.";
    else if (strength < 3)
      e.password = "Password is too weak. Use uppercase, numbers, and symbols.";
  ...
  const handleSubmit = async (ev) => {
    ...
    try {
      await registerUser({
        ...
        approved: false, // admins always start pending — a super-admin approves them
      });
      setSuccess(true);
      ...
      <div className="auth-panel-left admin-panel-left">
        ...
        <div className="auth-left-body">
          ...
          <p className="auth-left-desc">
            ...
            super-administrator. All accounts are subject to review before
            activation.
          </p>
        ...
        <div className="auth-form-wrap">
          ...
          <div className="auth-form-header">
            ...
            <p className="auth-form-subtitle">
              Complete this form with your authorization code to request an
              admin account.
            </p>
          </div>
          ...
          {success && (
            <div className="auth-success">
              ✓ &nbsp;Request submitted. A super-admin will review your account
              within 24 hours.
            </div>
          )}
          ...
          {!success && (
            <form className="auth-form" onSubmit={handleSubmit} noValidate>
              ...
              <div className="auth-field">
                ...
                {errors.role && (
                  <span className="auth-field-error">{errors.role}</span>
                )}
              </div>
              ...
              <div className="auth-field">
                ...
                <div className="auth-input-wrap">
                  <span className="auth-input-icon">🔑</span>
                  <input
                    className={`auth-input ${errors.accessCode ? "error" : ""}`}
                    type="text"
                    placeholder="Issued by super-administrator"
                ...
                {errors.accessCode && (
                  <span className="auth-field-error">{errors.accessCode}</span>
                )}
              </div>
              ...
              <label className="auth-checkbox-row">
                <input
                  ...
                  onChange={(e) => {
                    ...
                    if (errors.terms)
                      setErrors((er) => ({ ...er, terms: null }));
                  }}
                  onMouseEnter={expand}
                  onMouseLeave={shrink}
                />
                I acknowledge my administrator responsibilities and agree to
                the&nbsp;
                <a href="/admin-policy">Admin Policy</a>&nbsp;and&nbsp;
          ...
          <div className="auth-footer-link">
            ...
            <Link to="/admin/login" onMouseEnter={expand} onMouseLeave={shrink}>
              Sign in here
            </Link>
          </div>
