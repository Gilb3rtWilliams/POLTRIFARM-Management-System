    ...
    <div className="Homepage">
      ...
      <section className="hero-section" id="hero">
        ...
        <div className="hero-content">
          ...
          <p className="hero-sub">
            POLTRIFARM brings enterprise-grade intelligence to poultry
            operations — flock health monitoring, financial analytics, and
            multi-farm control, all in one elegant platform.
          </p>
      ...
      <section className="services-section" id="services">
        <div className="section-inner">
          <div
            className={`section-header reveal ${servicesVis ? "visible" : ""}`}
            ref={servicesRef}
          >
      ...
      <section className="why-section" id="why">
        <div className="why-visual-col">
          <div
            className={`why-img-wrap reveal ${whyVis ? "visible" : ""}`}
            ref={whyRef}
          >
            <img
        ...
        <div
          className={`why-content-col reveal ${whyVis ? "visible" : ""}`}
            ...
            {[
              {
                ...
                desc: "Live data streams from your farm floor. Alerts sent instantly to your phone the moment something needs attention.",
              },
              {
                icon: "🔐",
                title: "Enterprise-Grade Security",
                desc: "Your farm data is encrypted, backed up, and fully yours. Role-based access controls for every team member.",
              },
              {
                icon: "📱",
                title: "Works Everywhere",
                desc: "Fully responsive across desktop, tablet, and mobile. Manage your flock from the barn, office, or on the road.",
              },
              {
                icon: "🤝",
                title: "Dedicated Onboarding",
                desc: "Our team walks alongside you from setup to scale. Training, migration, and ongoing support included in every plan.",
              },
            ].map((f) => (
      ...
      <section className="about-section" id="about">
        <div className="section-inner about-inner">
          <div
            className={`about-left reveal ${aboutVis ? "visible" : ""}`}
            ref={aboutRef}
          >
            ...
            <blockquote className="about-quote">
              "We built the system we always wished existed when we were running
              our own flocks."
            </blockquote>
          </div>

          <div
            className={`about-right reveal ${aboutVis ? "visible" : ""}`}
            style={{ transitionDelay: "180ms" }}
          >
            <p>
              POLTRIFARM was born out of{" "}
              <strong>frustration and necessity</strong>. Our founders spent
              years managing mid-scale poultry operations and saw first-hand how
              fragmented, paper-based software was failing farmers at every
              turn.
            </p>
            <p>
              In 2019, we set out to build something different — a{" "}
              <strong>
                management system designed by farmers, for farmers
              </strong>
              . We spent two years in the field before writing a single line of
              code.
            </p>
            <p>
              Today, POLTRIFARM is trusted by farms managing everything from 500
              birds to half a million.{" "}
              <strong>Our mission remains the same:</strong> make world-class
              farm management accessible to everyone.
            </p>
              ...
              {[
                {
                  year: "2019",
                  title: "Founded",
                  desc: "Established with a vision to digitize poultry farm management across the region.",
                },
                {
                  year: "2020",
                  title: "First 50 Farms Onboarded",
                  desc: "Launched our beta, collecting feedback to build the platform farmers actually needed.",
                },
                {
                  year: "2022",
                  title: "Analytics Engine Launched",
                  desc: "Released our proprietary analytics module — unprecedented insight into flock performance.",
                },
                {
                  year: "2024",
                  title: "Multi-Farm Dashboard",
                  desc: "Expanded to support enterprise-level management, serving agribusiness groups nationwide.",
                },
              ].map((m) => (
      ...
      <section className="testimonials-section" id="testimonials">
        <div
          className={`testimonials-header reveal ${testiVis ? "visible" : ""}`}
          ref={testimonialsRef}
        >
          <SectionLabel>Client Voices</SectionLabel>
          <h2 className="section-title">
            Trusted by <em>Real Farmers</em>
          </h2>
        </div>
            ...
            {[
              {
                initials: "JM",
                name: "James Morales",
                role: "Owner, Morales Poultry Estate",
                text: '"POLTRIFARM gave us visibility we never had before. Mortality dropped 35% in our first production cycle."',
              },
              {
                initials: "SA",
                name: "Sandra Alcantara",
                role: "CFO, AgriNest Holdings",
                text: '"The financial reporting alone paid for the subscription in the first month. Finally know my actual cost per bird."',
              },
              {
                initials: "RT",
                name: "Ramon Torres",
                role: "Operations Director, Torres Agri",
                text: '"Managing 4 farms used to require 3 people. Now one manager handles everything from a single screen."',
              },
              {
                initials: "MV",
                name: "Maria Villanueva",
                role: "Farm Manager, Sun Valley Poultry",
                text: '"Onboarding was seamless. The team was with us every step. We were fully live in under two weeks."',
              },
              {
                initials: "LD",
                name: "Luis Domingo",
                role: "Biosecurity Officer, PrimeFlock",
                text: '"The biosecurity audit feature alone is worth it. We passed our certification with zero surprises."',
              },
              {
                initials: "JM",
                name: "James Morales",
      ...
      <section className="contact-section" id="contact">
        <div className="section-inner contact-inner">
          <div
            className={`contact-left reveal ${contactVis ? "visible" : ""}`}
            ref={contactRef}
          >
            ...
            <p className="contact-intro">
              Our team will walk you through a personalized demo and help you
              find the right plan — no commitment required.
            </p>
              ...
              {[
                {
                  icon: "📍",
                  label: "Address",
                  value: "123 Farm Road, AgriCity, Province",
                },
