...
export const ALL_SERVICES = [
  {
    ...
    sub: "Track every batch from hatch to market.",
  ...
  },
  {
    ...
    sub: "Real-time dashboards powered by your data.",
  ...
  },
  {
    ...
    sub: "Disease surveillance & biosecurity tools.",
  ...
  },
  {
    ...
    icon: "🌾",
    name: "Feed & Inventory",
    sub: "Automated forecasting & stock alerts.",
    path: "/feed-inventory",
  },
  {
    id: "finance",
    ...
    sub: "Profit-and-loss per batch, cost breakdowns.",
  ...
  },
  {
    ...
    sub: "Manage multiple farms from one place.",
    ...
    <div style={{ minHeight: "100vh", background: "var(--navy)" }}>
      ...
      <nav className="docs-nav">
        <Link
          ...
          onMouseLeave={shrink}
        >
          <span className="g">POLTRI</span>
          <span className="w">FARM</span>
        </Link>
      ...
      <section className="docs-hero">
        ...
        <div className="docs-hero-inner">
          <div className="docs-hero-left">
            <div
              className="docs-hero-service-badge"
              onMouseEnter={expand}
              onMouseLeave={shrink}
            >
          ...
          <div className="docs-hero-right">
            <div className="docs-feature-card-stack">
              {heroFeatures.map((f, i) => (
                ...
                >
                  <div
                    className="docs-feature-card-accent"
      ...
      <section id="how-to-use" className="docs-section alt-bg">
        <div className="docs-section-inner">
          ...
          <p className="docs-section-desc">
            Whether you're on your desktop at the office or checking in from the
            farm on your phone — here's exactly how to use this feature on both
            platforms.
          </p>
      ...
      <section className="other-services">
        ...
        <h2 className="docs-section-title" style={{ marginBottom: "0.5rem" }}>
        ...
        >
          POLTRIFARM brings every aspect of your farm into one intelligent
          platform.
        </p>
      ...
      <footer className="docs-footer">
        ...
        <div className="docs-footer-links">
          ...
          <Link to="/login" onMouseEnter={expand} onMouseLeave={shrink}>
            Sign In
          </Link>
